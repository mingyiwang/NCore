...
namespace Core.Test.Http {
    ...
    public class HttpRequestChannelTest {
        ...
        public void TestUrl()
        {
            ...
            Checking.CheckEquals(new Uri("https://google.com.au"), url.Uri);
        ...
        public void TestHost()
        {
            ...
            Checking.CheckEquals(new Uri("http://www.google.com.au/"), url.Uri);
        }
        ...
        public void TestGet()
        {
            ...
            Checking.CheckEquals(true, response.Success);
        }
