...
namespace Core.Drawing
{
    public sealed class Images
    {
        ...
        {
            Checking.CheckNotNull(image, "Source Image can not be null.");
            Checking.CheckNotEquals(0, width, "width can not be zero.");
            Checking.CheckNotEquals(0, height, "height can not be zero.");
