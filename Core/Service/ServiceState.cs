...
namespace Core.Service {
    ...
    public sealed class ServiceState {
        ...
        /// </summary>
        public const int Initialized = 100;
        ...
        public bool StopWhenStarting {
            get; private set;
        }

        public ServiceState() : this(Initialized) {
        }
        ...
        public void SetState(int code, bool stopWhenStarting) {
            StopWhenStarting = stopWhenStarting;
            Code = code;
            Name = GetName(code);
        }
        ...
        public static string GetName(int code) {
            switch(code) {
                ...
                case Failed:
                    return "Failed";
                default:
                    throw new ArgumentException("Unknow State Code#" + code);
            }
        }

        public static int GetCode(string name) {
            var lowCaseName = name.ToLower(CultureInfo.InvariantCulture);
            switch(lowCaseName) {
                case "initialized":
                    return Initialized;
                case "starting":
                ...
                case "failed":
                    return Failed;
                default:
                    throw new ArgumentException("Unknow State#" + name);
            }
        }
